...
assert.strictEqual(
  list.isEmpty(),
  false,
  "List should not be empty after insertion at head"
);
assert.strictEqual(
  list.length(),
  1,
  "Length should be 1 after one insertion at head"
);
...
assert.strictEqual(
  list.length(),
  2,
  "Length should be 2 after insertion at tail"
);
...
assert.strictEqual(
  list.length(),
  3,
  "Length should be 3 after insertion at position 1"
);
...
assert.strictEqual(
  list.search(99),
  false,
  "99 should not be found in the list"
);
...
assert.deepStrictEqual(
  list.toArray(),
  [10, 20],
  "List should be [10, 20] after deletion"
);
...
assert.deepStrictEqual(
  list.toArray(),
  [20, 10],
  "List should be reversed to [20, 10]"
);
